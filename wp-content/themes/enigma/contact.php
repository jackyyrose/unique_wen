...
Your Name:<br><input type="text" name="yourname" id="yourname" rows="1" value="" />
<br /><br />
Your Email:<br><input type="text" name="email" id="email" rows="1" value="" />
<br /><br />
Subject:<br><input type="text" name="subject" id="subject" rows="1" value=""></p>
<br /><br />
Leave a Message:<br><textarea name="message" id="message" style="width: 500px; height:300px;"></textarea>
<br /><br />
